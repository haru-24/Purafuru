...
var _chunkAF6COU6Djs = require('./chunk-AF6COU6D.js');
...
function parseSFC(code, id, options) {
  ...
  function handlePugTemplate(pugCode, id2) {
    try {
      const html = _chunkAF6COU6Djs.__require.call(void 0, "pug").compile(pugCode, { filename: id2 })();
...
function transformVue(input, id, options) {
  ...
  const attributes = _chunkAF6COU6Djs.__spreadValues.call(void 0, _chunkAF6COU6Djs.__spreadValues.call(void 0, {}, sfc.script.attrs), sfc.scriptSetup.attrs);
