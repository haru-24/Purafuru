<template>
  <div>
    ...
    <!-- レスポンシブ -->
    <div v-if="$mq === 'sm'">
      <div class="bg-white md:6/12 w-10/12 m-auto my-10 shadow-md rounded-lg">
        <h1
          class="
        ...
        <div action="" class="py-8 px-8 rounded-xl">
          <h1 class="font-medium text-base text-center">新規登録</h1>
          ...
          <div class="my-2 text-sm py-1 mt-3">
            <label for="username" class="block text-sm text-black mb-3"
              >出身地</label
            >
            <select
              v-model="registerData.birthPlace"
